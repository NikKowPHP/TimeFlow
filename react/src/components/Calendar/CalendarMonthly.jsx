...
export default function CalendarMonthly({dates, openTooltipId, handleActiveTaskState, handleTaskClick, currentDate, selectedDate}) {
        ...
        <ul>
          {dateTasks.slice(0,maxTasksToShow).map((task) => (
            <Tooltip
              ...
              onVisibilityChange={() => handleActiveTaskState(newState)}
              content={
                <div>
      ...
      <div className="calendar-by-month-wrapper">
        ...
        <ol className="calendar-by-month-dates">
          {dates.map((date, index) => (
            ...
            >
              <li
                className={`${calendarUtils().getActiveDateClass(date.toLocaleDateString(), currentDate, selectedDate)} date`}
